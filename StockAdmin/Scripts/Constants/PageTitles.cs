...
public abstract class PageTitles
{
    //***константы на чтение***
    public const string ClothOperation = "операции над одеждой";
    public const string History = "история действий";
    public const string Material = "материалы";
    public const string Model = "модель";
    public const string Operation = "операции";
    public const string Package = "пачки";
    public const string Person = "персонал";
    ...
    public const string AddModel = "добавление моделей";
    public const string AddModelPrice = "добавление цены в модель";
    public const string AddSize = "добавление / обновление размеров";
    public const string AddAge = "добавление / обновление растовок";
